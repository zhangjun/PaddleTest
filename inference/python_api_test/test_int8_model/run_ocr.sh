...
# 测速
python3.7 test_ocr_infer.py model_path="./PPOCRV3_det_QAT" model_filename="inference.pdmodel" params_filename="inference.pdiparams" image_file="test.jpg" device='GPU' use_trt=True precision='int8' benchmark=True backend_type=paddle
